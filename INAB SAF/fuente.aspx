<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="fuente.aspx.cs" Inherits="INAB_SAF.home" %>
		...
		<div id="page-wrapper">
		  <div class="header"> 
                        <h1 class="page-header">
                            Modulo administrativo <small>Mantenimiento de fuentes</small>
                        </h1>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="card-title">
                                        <div class="title">Nueva fuente</div>
                                    </div>
                                </div>
                                <div class="panel-body">
                                    <form class="form-inline">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="username" placeholder="Descripcion de la fuente">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail2">Correlativo</label>
                                            <input type="text" class="form-control" id="email" placeholder="Correlativo">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail2">Organismo</label>
                                            <input type="text" class="form-control" id="email" placeholder="Organismo">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail2">Codigo</label>
                                            <input type="text" class="form-control" id="email" placeholder="Codigo de fuente">
                                        </div>
                                        <div class="form-group">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="even gradeC">
                                            ...
                                            <td>0000</td>
                                            <td>0000</td>
                                            <td>Disminucion de caja y bancos de ingresos propios</td>
                                            <td><button class="btn btn-primary"><i class="fa fa-edit "></i> Modificar</button></td>
                                            <td><button class="btn btn-danger"><i class="fa fa-pencil"></i> Eliminar</button></td>
                                        </tr>
                                        <tr class="even gradeC">
