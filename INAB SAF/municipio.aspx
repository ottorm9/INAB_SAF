<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="municipio.aspx.cs" Inherits="INAB_SAF.home" %>
		...
		<div id="page-wrapper">
		  <div class="header"> 
                        <h1 class="page-header">
                            Modulo administrativo <small>Mantenimiento de municipios</small>
                        </h1>
                                ...
                                <div class="panel-body">
                                    <form class="form-inline">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="username" placeholder="Nombre del municipio">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail2">Codigo</label>
                                            <input type="text" class="form-control" id="email" placeholder="Codigo de municipio">
                                        </div>
                                        <div class="form-group">
                                            <label for="etnia">Departamento</label>
                                            <select class="selectbox">
                                                <optgroup label="Departamento">
                                                    <option value="CA">Alta Verapaz</option>
                                                    <option value="NV">Baja Verapaz</option>
                                                    <option value="OR">Chimaltenango</option>
                                                    <option value="WA">Chiquimula</option>
                                                    <option value="WA">El progreso</option>
                                                    <option value="WA">Escuintla</option>
                                                    <option value="WA">Guatemala</option>
                                                    <option value="WA">Huehuetenango</option>
                                                    <option value="WA">Izabal</option>
                                                    <option value="WA">Jalapa</option>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="even gradeC">
                                            <td>1602</td>
                                            <td>Santa Cruz Verapaz</td>
                                            <td><button class="btn btn-primary"><i class="fa fa-edit "></i> Modificar</button></td>
                                            <td><button class="btn btn-danger"><i class="fa fa-pencil"></i> Eliminar</button></td>
                                        </tr>
                                        <tr class="even gradeC">
                                            <td>1603</td>
                                            <td>San Cristóbal Verapaz</td>
                                            <td><button class="btn btn-primary"><i class="fa fa-edit "></i> Modificar</button></td>
                                            <td><button class="btn btn-danger"><i class="fa fa-pencil"></i> Eliminar</button></td>
                                        </tr>
                                        <tr class="even gradeC">
