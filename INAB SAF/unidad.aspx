<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="unidad.aspx.cs" Inherits="INAB_SAF.home" %>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="card-title">
                                        <div class="title">Nueva Unidad</div>
                                    </div>
                                </div>
                                <div class="panel-body">
                                    <form class="form-inline">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="username" placeholder="Nombre de la unidad">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail2">Actividad</label>
                                            <input type="text" class="form-control" id="email" placeholder="Actividad">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail2">Jerarquia</label>
                                            <input type="text" class="form-control" id="email" placeholder="Jerarquia">
                                        </div>
                                        <div class="form-group">
