<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="subregion.aspx.cs" Inherits="INAB_SAF.home" %>
		...
		<div id="page-wrapper">
		  <div class="header"> 
                        <h1 class="page-header">
                            Modulo administrativo <small>Mantenimiento de subregiones</small>
                        </h1>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="card-title">
                                        <div class="title">Nueva Sub Region</div>
                                    </div>
                                </div>
                                <div class="panel-body">
                                    <form class="form-inline">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="username" placeholder="Nombre del sub region">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail2">No. Sub Region</label>
                                            <input type="text" class="form-control" id="email" placeholder="Numero de sub region">
                                        </div>
                                        <div class="form-group">
